  ...
  return (
    <section id="negotiation" className="min-h-[655px] w-full bg-black font-poppins flex sm:min-h-[700px] md:min-h-[700px]  lg:min-h-[790px] xl:min-h-[880px]">
      ...
      >
        ...
        <div className="grid grid-rows-6 gap-10 mt-10 ml-[50px] md:mr-[30px] sm:mr-[20px]">
      ...
      <div className="bg-[url('/trading2.jpg')] w-[50%] bg-no-repeat bg-cover sm:hidden md:hidden block" />
    </section>
  )
}
