...
export default function About() {
  return (
    <section className="h-[600px] bg-[#181818] py-[50px] flex flex-col items-center justify-around sm:h-[1000px] md:h-[910px]">

      <h1 className="uppercase font-bold text-[45px] text-center text-white sm:text-[30px] md:text-[32px]">sobre a fot</h1>

      <p className="text-white font-bold text-center text-[20px] sm:text-[16px] md:text-[16px] xl:max-w-[1100px] 2xl:max-w-[1100px]">
      ...
      <div className="grid grid-cols-5 sm:grid-cols-1 md:grid-cols-1 mt-10 sm:mt-2">
        {about.map((item) => (
          <div key={item.id}>
