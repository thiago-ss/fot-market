      ...
      <div className="overflow-hidden ">
        ...
        >
          ...
          <p className="font-montserrat text-[20px] text-[#3C3400] max-w-[707px] sm:text-[16px] md:text-[17px] lg:text-[19px]">
            O METATRADER 5 é uma plataforma para realizar transações de forma
            rápida e prática, contendo todos os ativos. Utilizada por cerca de 7
            milhões de pessoas no planeta, usada tanto por especialistas quanto
            por investidores menos experientes.
          </p>
          ...
          <img
            src="/Metatrade-SVG.svg"
            alt="Metatrader 5 logo"
            className="w-[140px] md:w-[200px] mr-auto ml-auto sm:hidden lg:hidden xl:hidden 2xl:hidden"
          />
        </div>
      </div>
    </section>
