...
export default function Webinarios() {
  return (
    <section>
      ...
      >
        <div className="h-[750px] bg-[url('/bg-webinararios.png')] bg-cover bg-no-repeat sm:h-[700px] md:h-[630px]">
          <motion.div
            variants={fadeIn('right', 'tween', 0.2, 1)}
            className="grid grid-cols-1 gap-6 font-poppins text-white p-[170px] sm:p-[10px] md:text-[11px] md:p-[10px]"
          >
            <h1 className=" font-bold text-[45px] sm:text-[30px] sm:mt-10 md:mt-10 md:text-[30px]">WEBINÁRIOS</h1>
            <p className="max-w-[768px] font-semibold text-[22px] sm:max-w-[100%] sm:text-[16px] md:text-[18px] md:max-w-[100%]">
          ...
          <motion.div
            ...
            className="flex gap-[20px] items-center bg-[#C6AA0E] w-[315px] h-[70px] px-5 py-5 rounded-[8px]  opacity-80 absolute -bottom-[650px] right-[15px] sm:-bottom-[1450px] md:-bottom-[960px] md:-left-1"
          >
