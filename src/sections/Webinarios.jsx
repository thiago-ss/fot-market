...
export default function Webinarios() {
  return (
    <section>
      ...
      >
        <div className="h-[750px] bg-[url('/bg-webinararios.png')] bg-cover bg-no-repeat sm:h-[960px]">
          <motion.div
          ...
          >
            ...
            <p className="max-w-[768px] font-semibold text-[22px] sm:max-w-[100%]">
          ...
          <motion.div
            ...
            className="flex gap-[20px] items-center bg-[#C6AA0E] w-[315px] h-[70px] px-5 py-5 rounded-[8px]  opacity-80 absolute -bottom-[650px] right-[15px] sm:-bottom-[1500px]"
          >
