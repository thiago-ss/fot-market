	...
	return (
		<nav className="w-full shadow bg-[#181818] font-montserrat fixed z-10 p-[10px] sm:max-w-[320px] md:max-w-[100%]">
			<div className="justify-between px-4 mx-auto xl:items-center xl:flex xl:px-8 2xl:items-center 2xl:flex 2xl:px-8">
				<div>
					<div className="flex items-center justify-between py-3 xl:py-5 xl:block 2xl:py-5 2xl:block">
						...
						<div className="xl:hidden 2xl:hidden">
							<button className="p-2 text-gray-700 rounded-2xl outline-none focus:border-gray-400 focus:border" onClick={() => setNavbar(!navbar)}>
								{navbar ? (
				...
				<div>
					<div className={`flex-1 justify-self-center pb-3 mt-8 xl:block xl:pb-0 xl:mt-0 2xl:block 2xl:pb-0 2xl:mt-0 ${navbar ? "block" : "hidden"}`}>
						<ul className="items-center justify-center space-y-8 xl:flex xl:space-x-6 xl:space-y-0 2xl:flex 2xl:space-x-6 2xl:space-y-0 font-semibold">
							...
							<li className="text-white hover:text-indigo-200">
								...
								<div id="dropdownInformation" class="z-10 hidden bg-[#111111] divide-y rounded-lg shadow w-44">
									<ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownInformationButton">
										<li>
											<a href="#" class="block px-4 py-2 dark:hover:bg-gray-600 text-[14px]">
												Dashboard
											</a>
										</li>
										<li>
										...
										<li>
											<a href="#" className="block px-4 py-2 dark:hover:bg-gray-600 text-[14px]">
												Earnings
											</a>
										</li>
									</ul>
